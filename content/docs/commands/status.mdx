...
description: watchfire status prints a snapshot of the current project — active agent sessions, task queue counts, and the last few lines of every running PTY.
---
