---
title: Overview
description: Better context. Better code. Watchfire turns clear specs into scoped tasks, then lets Claude Code, Codex, opencode, and Gemini CLI build them in sandboxed git worktrees.
---
