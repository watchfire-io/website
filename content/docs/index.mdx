---
title: Watchfire
description: Watchfire documentation — turn specs into scoped tasks, hand each one to Claude Code, Codex, opencode, Gemini, Copilot, or Cursor in a sandboxed worktree.
---
...
- [Cheatsheet](/cheatsheet) — One-page printable reference for the whole workflow (CLI, TUI, YAML, modes, gotchas)
- [Troubleshooting](/docs/troubleshooting) — Common errors and copy-paste fixes
- [Roadmap](/docs/roadmap) — Where Watchfire is heading after Forge
