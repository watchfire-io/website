---
title: Watchfire
description: Better context. Better code. Watchfire turns clear specs into scoped tasks, then lets Claude Code, Codex, opencode, Gemini CLI, GitHub Copilot CLI, or Cursor build them in sandboxed git worktrees.
---
...
- [Roadmap](/docs/roadmap) — Where Watchfire is heading after Phoenix
