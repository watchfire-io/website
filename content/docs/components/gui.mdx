...
| Tab | Content |
|-----|---------|
| **Chat** | Live agent terminal streamed from daemon. Tasks created by agents during chat sessions appear in real-time in the Tasks tab without needing a manual refresh. |
