...
Beacon is Watchfire's consolidated dashboard, notifications, insights, and integrations release. It groups four parallel feature tracks under one banner — a glanceable dashboard, proactive OS notifications, retrospective insights, and outbound + inbound integrations.
