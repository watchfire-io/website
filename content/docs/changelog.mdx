...
[Beacon](/docs/glossary#beacon) is Watchfire's consolidated dashboard, notifications, insights, and integrations release. It groups four parallel feature tracks under one banner — a glanceable dashboard, proactive OS notifications, retrospective [insights](/docs/glossary#insights), and outbound + inbound integrations powered by a new [notification bus](/docs/glossary#notification-bus).
