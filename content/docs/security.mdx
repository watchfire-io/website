...
<Callout type="info">
Looking for the marketing overview? See [/security](/security) for the high-level page; this is the canonical technical reference.
</Callout>
...
The machine-readable security contact is published at [`/.well-known/security.txt`](/.well-known/security.txt) per [RFC 9116](https://www.rfc-editor.org/rfc/rfc9116).
