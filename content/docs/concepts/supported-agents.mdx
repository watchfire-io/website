...
description: Supported agent backends — Claude Code, Codex, opencode, Gemini CLI, Copilot CLI, Cursor Agent. What to install, how to auth, how Watchfire finds each one.
---
