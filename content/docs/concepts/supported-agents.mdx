...
description: Watchfire supports Claude Code, OpenAI Codex, opencode, and Gemini CLI. Learn what to install, how authentication works, and how Watchfire finds each backend.
---
