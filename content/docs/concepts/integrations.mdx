---
title: Integrations
description: Watchfire integrations — outbound webhooks plus Slack, Discord, and GitHub auto-PR adapters, and an inbound HTTP server with HMAC signature verification.
---
