...
Watchfire uses git [worktrees](/docs/glossary#worktree) to isolate each task's work from the main working tree and from other tasks. This means agents can make changes freely without affecting your main branch or other running tasks.
