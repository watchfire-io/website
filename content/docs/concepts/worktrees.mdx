...
description: Git worktree isolation — every Watchfire task runs in its own worktree on a dedicated branch, isolated from your main tree and from concurrent agents.
---
