    ...
    <div className="hero-illustration relative w-full max-w-lg mx-auto lg:mx-0">
      ...
      >
        ...
        <defs>
          ...
          <linearGradient id="purpleFlow" x1="0" y1="0" x2="1" y2="1">
        ...
        <g className="hero-terminal">
          ...
          {/* Traffic lights */}
          <circle cx="64" cy="48" r="5" fill="#ef4444" opacity="0.7" />
          <circle cx="82" cy="48" r="5" fill="#eab308" opacity="0.7" />
          <circle cx="100" cy="48" r="5" fill="#22c55e" opacity="0.7" />
          {/* Title text */}
        ...
        <g className="hero-task hero-task-1">
          ...
          <circle cx="80" cy="98" r="6" fill="#a855f7" opacity="0.9" />
        ...
        <g className="hero-task hero-task-2">
          <rect x="60" y="124" width="360" height="36" rx="6" fill="#1c1c1f" stroke="#a855f7" strokeWidth="0.5" strokeOpacity="0.5" />
          <circle cx="80" cy="142" r="6" fill="none" stroke="#a855f7" strokeWidth="1.5" />
          {/* Spinning indicator */}
          <circle cx="80" cy="142" r="6" fill="none" stroke="#a855f7" strokeWidth="1.5" strokeDasharray="8 24" className="hero-spinner" />
          <text x="96" y="146" fill="#e4e4e7" fontSize="12" fontFamily="monospace">Add API endpoints</text>
          <rect x="324" y="134" width="76" height="16" rx="4" fill="#581c87" opacity="0.6" />
          <text x="362" y="145" textAnchor="middle" fill="#c084fc" fontSize="9" fontFamily="monospace">running</text>
        </g>
        ...
        <g className="hero-branches" opacity="0.5">
          <path d="M 240 310 Q 180 330 160 360" stroke="#a855f7" strokeWidth="1.5" fill="none" strokeDasharray="4 4" />
          <path d="M 240 310 L 240 370" stroke="#71717a" strokeWidth="1.5" fill="none" />
          <path d="M 240 310 Q 300 330 320 360" stroke="#a855f7" strokeWidth="1.5" fill="none" strokeDasharray="4 4" />
          <circle cx="240" cy="310" r="4" fill="#a855f7" />
          <circle cx="160" cy="362" r="3" fill="#c084fc" />
          <circle cx="240" cy="372" r="3" fill="#71717a" />
          <circle cx="320" cy="362" r="3" fill="#c084fc" />
