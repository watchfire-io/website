      ...
      <div className="mx-auto max-w-7xl px-6 py-14">
        <div className="flex flex-col items-center gap-8 sm:flex-row sm:items-start sm:justify-between">
          ...
          <ul className="flex flex-wrap items-center justify-center gap-x-6 gap-y-3 text-sm">
            ...
            <li>
              <Link href="/templates" className="text-zinc-500 transition-colors hover:text-fire-600 dark:text-zinc-400 dark:hover:text-fire-400">
                Templates
              </Link>
            </li>
            <li>
              <Link href="/built-with-watchfire" className="text-zinc-500 transition-colors hover:text-fire-600 dark:text-zinc-400 dark:hover:text-fire-400">
                Built with Watchfire
              </Link>
            </li>
            <li>
              <Link href="/integrations" className="text-zinc-500 transition-colors hover:text-fire-600 dark:text-zinc-400 dark:hover:text-fire-400">
                Integrations
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/community" className="text-zinc-500 transition-colors hover:text-fire-600 dark:text-zinc-400 dark:hover:text-fire-400">
                Community
              </Link>
            </li>
            <li>
              <Link href="/faq" className="text-zinc-500 transition-colors hover:text-fire-600 dark:text-zinc-400 dark:hover:text-fire-400">
                FAQ
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/badge" className="text-zinc-500 transition-colors hover:text-fire-600 dark:text-zinc-400 dark:hover:text-fire-400">
                Badges
              </Link>
            </li>
            <li>
              <Link href="/press" className="text-zinc-500 transition-colors hover:text-fire-600 dark:text-zinc-400 dark:hover:text-fire-400">
                Press
              </Link>
            </li>
            <li>
