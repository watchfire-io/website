  ...
  },
  {
    ...
    illustration: (
      <svg viewBox="0 0 400 280" fill="none" className="h-full w-full">
        ...
        {/* Merge arrow */}
        <text x="285" y="125" className="fill-zinc-400 dark:fill-zinc-600" fontSize="9" fontFamily="monospace">merged</text>
      </svg>
    ),
  },
  {
    ...
    illustration: (
      <svg viewBox="0 0 400 280" fill="none" className="h-full w-full">
        ...
        <text x="185" y="114" className="fill-zinc-500 dark:fill-zinc-400" fontSize="10" fontFamily="monospace">filesystem</text>

        <g transform="translate(165, 140)">
          <circle r="10" fill="#22c55e" opacity="0.15" />
          <polyline points="-4,0 -1,3 5,-3" stroke="#22c55e" strokeWidth="1.5" fill="none" strokeLinecap="round" />
        </g>
        <text x="185" y="144" className="fill-zinc-500 dark:fill-zinc-400" fontSize="10" fontFamily="monospace">network</text>
        ...
        <text x="185" y="174" className="fill-zinc-500 dark:fill-zinc-400" fontSize="10" fontFamily="monospace">~/.ssh, ~/.aws</text>
        ...
        <text x="185" y="204" className="fill-zinc-500 dark:fill-zinc-400" fontSize="10" fontFamily="monospace">.git/hooks</text>
      </svg>
    ),
  },
  {
    ...
    illustration: (
      <svg viewBox="0 0 400 280" fill="none" className="h-full w-full">
        ...
        {/* Project 1 - top left */}
        <rect x="30" y="30" width="100" height="50" rx="8" className="fill-zinc-100 stroke-zinc-300 dark:fill-zinc-800 dark:stroke-zinc-700" strokeWidth="1" />
        <rect x="42" y="42" width="40" height="4" rx="2" fill="#22c55e" opacity="0.6" />
        <rect x="42" y="52" width="70" height="3" rx="1.5" className="fill-zinc-300 dark:fill-zinc-600" />
        <rect x="42" y="61" width="55" height="3" rx="1.5" className="fill-zinc-200 dark:fill-zinc-700" />
        <line x1="100" y1="80" x2="175" y2="110" className="stroke-zinc-300 dark:stroke-zinc-700" strokeWidth="1" strokeDasharray="4 3" />

        {/* Project 2 - top right */}
        <rect x="270" y="30" width="100" height="50" rx="8" className="fill-zinc-100 stroke-zinc-300 dark:fill-zinc-800 dark:stroke-zinc-700" strokeWidth="1" />
        <rect x="282" y="42" width="50" height="4" rx="2" fill="#eab308" opacity="0.6" />
        <rect x="282" y="52" width="65" height="3" rx="1.5" className="fill-zinc-300 dark:fill-zinc-600" />
        <rect x="282" y="61" width="45" height="3" rx="1.5" className="fill-zinc-200 dark:fill-zinc-700" />
        <line x1="300" y1="80" x2="225" y2="110" className="stroke-zinc-300 dark:stroke-zinc-700" strokeWidth="1" strokeDasharray="4 3" />

        {/* Project 3 - bottom left */}
        <rect x="30" y="200" width="100" height="50" rx="8" className="fill-zinc-100 stroke-zinc-300 dark:fill-zinc-800 dark:stroke-zinc-700" strokeWidth="1" />
        <rect x="42" y="212" width="45" height="4" rx="2" fill="#3b82f6" opacity="0.6" />
        <rect x="42" y="222" width="75" height="3" rx="1.5" className="fill-zinc-300 dark:fill-zinc-600" />
        <rect x="42" y="231" width="50" height="3" rx="1.5" className="fill-zinc-200 dark:fill-zinc-700" />
        <line x1="100" y1="200" x2="175" y2="170" className="stroke-zinc-300 dark:stroke-zinc-700" strokeWidth="1" strokeDasharray="4 3" />

        {/* Project 4 - bottom right */}
        <rect x="270" y="200" width="100" height="50" rx="8" className="fill-zinc-100 stroke-zinc-300 dark:fill-zinc-800 dark:stroke-zinc-700" strokeWidth="1" />
        <rect x="282" y="212" width="55" height="4" rx="2" fill="#ef4444" opacity="0.6" />
        <rect x="282" y="222" width="60" height="3" rx="1.5" className="fill-zinc-300 dark:fill-zinc-600" />
        <rect x="282" y="231" width="70" height="3" rx="1.5" className="fill-zinc-200 dark:fill-zinc-700" />
        ...
        <div className="mt-16 space-y-24">
          {features.map((feature, i) => (
            ...
            >
              ...
              <div className="w-full max-w-md flex-1 rounded-xl border border-zinc-200 bg-zinc-50/60 p-4 dark:border-zinc-800 dark:bg-zinc-900/60">
