        ...
        <div className="mx-auto mt-14 flex max-w-5xl flex-wrap justify-center gap-5">
          {agents.map((agent) => (
            <div
              key={agent.tag}
              data-stagger
              className="card-hover group relative w-full overflow-hidden rounded-2xl border border-zinc-200 bg-white/70 p-6 backdrop-blur-sm dark:border-zinc-800 dark:bg-zinc-900/60 sm:w-[calc(50%-0.625rem)] md:w-72"
              style={{
