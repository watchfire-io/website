          ...
          <div className="grid grid-cols-5 gap-6">
            {steps.map((step) => (
              <div key={step.number} className="relative flex flex-col items-center text-center">
                <div className="relative z-10 flex h-16 w-16 items-center justify-center rounded-full border border-purple-500/30 bg-zinc-900 text-purple-400 shadow-lg shadow-purple-500/10">
                  {step.icon}
                </div>
                <span className="mt-1 text-xs font-medium text-purple-400">
                  Step {step.number}
                </span>
          ...
          <div className="relative space-y-10 pl-10">
            ...
            {steps.map((step) => (
              <div key={step.number} className="relative flex items-start gap-4">
                <div className="absolute -left-5 flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-purple-500/30 bg-zinc-900 text-purple-400 shadow-lg shadow-purple-500/10">
