...
const STATIC_ROUTES = new Set([
  ...
  "/templates/add-docs",
  "/templates/add-small-feature",
  "/templates/add-tests",
  "/templates/fix-a-bug",
  "/templates/investigate-and-report",
  "/templates/perf-regression-hunt",
  "/templates/refactor-or-rename",
  "/templates/update-dependency",
  "/use-cases/docs-sprint",
  "/use-cases/migration",
  "/use-cases/parallel-work",
  "/use-cases/refactor",
  "/use-cases/review-prep",
  "/use-cases/switch-from-raw-cli",
