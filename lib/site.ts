export const siteUrl = "https://watchfire.io";

export const siteName = "Watchfire";

export const siteTagline = "Better context. Better code.";
...
export const softwareVersion = "10.0.0";
